...
export default function Navbar() {
  ...
  return (
    <nav
      className="fixed top-0 left-1/2 transform -translate-x-1/2 w-full lg:w-1/3 h-12 p-2 border-b-[1px] border-gray-400 dark:border-gray-800 bg-gray-100 dark:bg-gray-950 opacity-85 z-50"
