    ...
    <div className="bg-gray-950 rounded-lg p-6 mt-4 border-2 border-gray-500 relative max-h-[30rem] overflow-y-auto hide-scrollbar">
      ...
      <ul className="space-y-6">
        <li className="flex items-center space-x-4 relative">
          ...
          />
          <div>
            <strong className="text-lg">Tutor.com</strong> - Computer Science Tutor
        ...
        <li className="flex items-center space-x-4 relative">
          ...
          />
          <div>
            <strong className="text-lg">Cognimetrics</strong> - Web Developer
        ...
        <li className="flex items-center space-x-4 relative">
          ...
          />
          <div>
            <strong className="text-lg">Indian River Estates</strong> - Line Cook
